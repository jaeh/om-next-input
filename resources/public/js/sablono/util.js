...
var x__17030__auto__ = (((x == null))?null:x);
var m__17031__auto__ = (sablono.util.to_str[goog.typeOf(x__17030__auto__)]);
if(!((m__17031__auto__ == null))){
return m__17031__auto__.call(null,x);
} else {
var m__17031__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__17031__auto____$1 == null))){
return m__17031__auto____$1.call(null,x);
} else {
...
var x__17030__auto__ = (((x == null))?null:x);
var m__17031__auto__ = (sablono.util.to_uri[goog.typeOf(x__17030__auto__)]);
if(!((m__17031__auto__ == null))){
return m__17031__auto__.call(null,x);
} else {
var m__17031__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__17031__auto____$1 == null))){
return m__17031__auto____$1.call(null,x);
} else {
...
var len__17433__auto___21125 = arguments.length;
var i__17434__auto___21126 = (0);
while(true){
if((i__17434__auto___21126 < len__17433__auto___21125)){
args__17440__auto__.push((arguments[i__17434__auto___21126]));

var G__21127 = (i__17434__auto___21126 + (1));
i__17434__auto___21126 = G__21127;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__17441__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq21124){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq21124));
});
/**
...
var vec__21129 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__21129,(0),null);
var words = cljs.core.nthnext.call(null,vec__21129,(1));
...
var G__21131 = clojure.set.rename_keys.call(null,m,kmap);
var G__21131__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__21131,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__21131);
return G__21131__$1;
} else {
return m;
}
...
var args__17440__auto__ = [];
var len__17433__auto___21134 = arguments.length;
var i__17434__auto___21135 = (0);
while(true){
if((i__17434__auto___21135 < len__17433__auto___21134)){
args__17440__auto__.push((arguments[i__17434__auto___21135]));

var G__21136 = (i__17434__auto___21135 + (1));
i__17434__auto___21135 = G__21136;
continue;
} else {
}
break;
...
var argseq__17441__auto__ = ((((0) < args__17440__auto__.length))?(new cljs.core.IndexedSeq(args__17440__auto__.slice((0)),(0))):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__17441__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__21132_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__21132_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__21132_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__21132_SHARP_)){
return p1__21132_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__21132_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq21133){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq21133));
});
/**
...
var vec__21140 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__21140,(0),null);
var names = cljs.core.nth.call(null,vec__21140,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__21140,tag_name,names){
return (function (p1__21137_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__21137_SHARP_));
});})(matches,vec__21140,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__21140,tag_name,names){
return (function (p1__21138_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__21138_SHARP_));
});})(matches,vec__21140,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__21141){
var vec__21144 = p__21141;
var tag = cljs.core.nth.call(null,vec__21144,(0),null);
var content = cljs.core.nthnext.call(null,vec__21144,(1));
...
var vec__21145 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__21145,(0),null);
var id = cljs.core.nth.call(null,vec__21145,(1),null);
var class$ = cljs.core.nth.call(null,vec__21145,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__16375__auto__ = x__$1.hasDomain();
